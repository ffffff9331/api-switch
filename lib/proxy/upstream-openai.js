...
const { proxyMessagesViaChat, proxyResponsesViaChat, proxyResponsesViaCompletions } = require("./chat-bridge");
...
async function proxyResponses(args) {
  ...
  writeDebugLog(args.debugDir, "route-decision", {
    ...
    route: args.route,
    selected: protocol === "chat-completions" ? "chat-completions-bridge" : protocol === "completions" ? "completions-bridge" : "responses-passthrough",
  });
